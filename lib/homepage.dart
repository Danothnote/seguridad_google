...
class HomePageState extends State<HomePage> {
  ...
  Future<void> _gotoUser(double lat,double long) async {
          ...
          controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: LatLng(lat, long), zoom: 19,tilt: 0.0,
            bearing: 0.0,)));
        }
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: _boxes(
                        ...
                        -0.20896709262045476, -78.49102905261708,"PUCE"),
                  ),
                  SizedBox(width: 10.0),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: _boxes(
                        ...
                        -0.0896865815730905, -78.48241985389308,"SEK"),
                  ),
                ],
              ),
            ),
        ...
        Widget _buildGoogleMap(BuildContext context) {
          return Container(
            ...
            child: GoogleMap(
              ...
              markers: {
                puceMarker,usfqMarker,sekMarker
              },
            ),
          );
        }
        ...
        Future<void> _gotoLocation(double lat,double long) async {
          final GoogleMapController controller = await _controller.future;
          controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: LatLng(lat, long), zoom: 17,tilt: 0.0,
            bearing: 0.0,)));
        }
      }
